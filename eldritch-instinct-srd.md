...
# Eldritch Instinct System Reference Document (v0.7)
{: .no_toc }
...
This game is inspired by and combines mechanics from games like Mothership by Tuesday Knight Games (Critical Wounds), Cthulhu Dark by Graham Walmsley, Nemesis by Arc Dream Publishing (Notches), Cairn by Yochai Gal, Call of Cthulhu by Chaosium Inc. (Magic, Bonds), Into the Odd by Chris McDowall, Blades in the Dark by John Harper (Position and Effect) and Rats in the Walls by Kobayashi (Research).
...
First, choose or roll a **name** for your character, then their **occupation**, which informs their knowledge and potential skills (see tables on p. 7). Note however, that PCs do not hold positions of power.
...
A PC's Magic Points (MP) start at the PC's WIL score and are used to cast spells.
...
Roll on the **Bonds Table** (p. 7) to determine the four most significant things that tie your PC to this world. Use the results as a starting point and come up with something short and *specific*.
...
Investigators are confronted with life-threatening violence, mind-breaking revelations and demanding tasks. During play, conceive and adapt the reason why your character would push on despite all of this. See **Motivation Inspiration Table** to help you develop your PC's motivation.
...
Warden: Let’s roll the Tension Pool, as the showcase is probably secured with an electronic alarm system. *One die shows a 1.* That’s pretty bad. A bell in the corner of the room starts to ring and you hear footsteps coming up the stairs.
...
Warden: The amulet you were hoping to find appears to have been removed. Instead, you find what is undoubtedly another one of your husband’s fingers, ripped crudely off his hand. Make a WIL save or gain 1d4 Insight.
...
When you’ve had a chance to calm down, make a WIL save. On a success, draw a permanent box around an Insight pip starting at the 4 position going clockwise as you are **Hardened**. On a fail, cross out an Insight pip starting at the 12 position going counter-clockwise as you are **Broken** and write down a one word reminder.
...
Pips with a Broken notch cannot be filled when gaining Insight. If you cross out an Insight pip that is already Hardened, it counts as Broken until you remove the Broken notch. When you gain a Broken notch, describe how your character is affected and how they cope with their trauma. When you gain a Broken notch but cannot cross out another Insight pip, you permanently lose control of your character.
...
Further **study** of the tome takes a few (2d6) days, after which you may increase your MK by the tome’s Mythos rating. Every time, though, you must gain a Broken notch.
...
| 4 | Jump across a gap. | 11 | Jump over a fallen tree. | 18 | Fog or darkness. |
...
In the background or between scenarios, players can do a number of things that are summarized at the table. 
- They can read tomes to increase their Mythos Knowledge or learn spells,
...
When you’ve had a chance to calm down, make a WIL save. On a success, draw a permanent box around an Insight pip starting at the 1 position going clockwise as you are **Hardened**. On a fail, cross out an Insight pip starting at the 12 position going counter-clockwise as you are **Broken** and write down a one word reminder.

### Getting Better

There are a number of possibilities to remove Broken notches: Self-help, commitment to a sanatorium and covering traces.
